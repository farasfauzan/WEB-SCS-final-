...
function getDynamicKnowledgeBase(settings) {
  const address = settings.footer_address || "Jl. Karangrejo Barat No 09, RT. 02 RW. 02 (Kp. Pentul), Tinjomoyo, Semarang";
  ...
  return [
    ...
    {
      topic: "jam_kerja",
      keywords: ["jam kerja", "operasional", "buka jam", "tutup jam", "hari apa", "jadwal", "waktu buka"],
    ...
    },
    {
      ...
      keywords: ["anak perusahaan", "maharani", "globalindo", "jejaring", "sinergi", "unit bisnis", "anak usaha"],
    ...
    {
      topic: "sejarah",
      keywords: ["sejarah", "kapan berdiri", "didirikan", "asal usul", "perjalanan"],
    ...
    {
      topic: "keunggulan",
      keywords: ["keunggulan", "kenapa memilih", "kelebihan", "kenapa harus", "mengapa", "bagus"],
    ...
    {
      topic: "sertifikasi",
      keywords: ["sertifikasi", "iso", "legalitas", "ijin", "izin", "sertifikat"],
    ...
    {
      topic: "sop",
      keywords: ["sop", "standard operating", "prosedur", "panduan kerja", "aturan"],
