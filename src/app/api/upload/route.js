  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            "Cloudinary belum dikonfigurasi. Set CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, dan CLOUDINARY_API_SECRET di file .env.local",
        },
        { status: 500 },
      );
    }
    ...
    // KOREKSI: Hapus variabel folder dari string publicId agar Cloudinary tidak membuat folder ganda
