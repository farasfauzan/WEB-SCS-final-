  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {pagination.total > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-red-600 hover:text-red-700 bg-red-50 hover:bg-red-100 rounded-lg transition-colors"
            >
      ...
      {showConfirm && (
        ...
        >
          <div
            className="bg-white p-5 max-w-[280px] mx-4 border border-gray-200 shadow-2xl rounded-2xl"
                    ...
                    <tr key={log.id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-300 flex items-center justify-center text-[#004282] font-bold text-xs">
